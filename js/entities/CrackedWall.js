...
export class CrackedWall extends Phaser.Physics.Arcade.Sprite {
  ...
  // a mesma dos wallSkin de Constants.CITY_DISTRICTS (v1.8.10: + deserto;
  // v1.12: + alas do zoo, os wallSkin de Constants.ZOO_ALAS); valor fora
  // dela cai no zoológico, nunca numa textura inexistente.
