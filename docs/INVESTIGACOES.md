...
| ~~L2~~ | ~~**O painel `/?stats` é cego para 7 letras**~~ | ✅ **fechada na v1.9.12**: o `allRuns()` decodifica TODAS as chaves e a aba 🛡️ Chefes mostra o funil dos cinco (revisão adversarial de 3 lentes acatada: âncora exata igual à da radiografia, nota com as cegueiras de era, ramos de chegada testados com corrida verbatim) | — |
...
| ~~L4~~ | ~~**`n` é decodificado no painel e nunca usado**~~ | ✅ **fechada na v1.9.12**: a fúria negada em arena tem gráfico na aba Chefes e assert com n>0 | — |
